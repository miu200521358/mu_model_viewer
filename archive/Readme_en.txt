...
Double-click to launch, and the model will be displayed.
If you double-click this exe itself to launch it, only a blank window will appear.
...
MuModelViewer_1.0.0 (2025/02/11)
